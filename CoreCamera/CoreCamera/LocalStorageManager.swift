...
final class LocalStorageManager {
    ...
    static func localFilePathForUrl(_ previewUrl: String) -> URL? {
        ...
        if let url = URL(string: previewUrl) {
            let podcastDir = documentsPath.appendingPathComponent("images/\(url.lastPathComponent)")
    ...
    static func localFilePath(for url: URL) -> URL {
        ...
        let dir = documentsPath.appendingPathComponent("images/\(url.lastPathComponent)")
        return dir
    }
    
    static func makeDirectory() -> Bool {
